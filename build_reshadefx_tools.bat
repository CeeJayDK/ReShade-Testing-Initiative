...
echo #pragma once > "%VH%"
echo #define VERSION_MAJOR 6 >> "%VH%"
echo #define VERSION_MINOR 0 >> "%VH%"
echo #define VERSION_REVISION 0 >> "%VH%"
echo #define VERSION_STRING_PRODUCT "ReShade (mingw-built reshadefx tools)" >> "%VH%"
